...
#if !defined(_MSC_VER)||_MSC_VER>1750||_MSC_VER<1400
...
#define _LN_LIB_TYPE(s) _LN_CVER()##s##_LN_CHAR()_LN_MT()_LN_DEBUG()".lib"

#define _LN_LIB_TYPE_A(s) _LN_CVER()##s##_LN_MT()_LN_DEBUG()".lib"

#define _LN_LIB_TYPE_AS(s) s##_LN_MT()_LN_DEBUG()".lib"
